...
TOKEN = '7498365611:AAHxc1Exf83c3ZiLoYe8OyzgqsVwzHysPzU'
...
FORWARD_CHANNEL_ID = -4258210820
CHANNEL_ID = -4258210820
error_channel_id = -4258210820
...
def approve_or_disapprove_user(message):
    ...
    if not is_admin:
        bot.send_message(chat_id, "*GAREEB ACESS NAHI HAI🛑❌ PAY KAR OR ACCESS LE ✅ DM FOR PRICES - @Ddosman60*", parse_mode='Markdown')
        return
